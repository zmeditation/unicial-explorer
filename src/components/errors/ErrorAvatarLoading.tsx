...
import './errors.css'
import errorImage from '../../images/errors/error-world.png'
        ...
        <div className="errormessage">
            <div className="errortext col">
                ...
                <div className="givesomedetailof">
                    Please try again later, and if the problem persists you can contact us through the Discord channel
                    or at <a href="mailto:hello@decentraland.org">hello@decentraland.org</a>
                </div>
            </div>
